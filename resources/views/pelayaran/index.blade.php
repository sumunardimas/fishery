        ...
        <div class="col-12">
            ...
            <div class="row">
                @forelse ($activePelayaran as $item)
                    <div class="col-xl-4 col-lg-6 mb-4"
						...
						&& (@js(strtolower($item->kapal->nama_kapal ?? '')).includes(search.toLowerCase()))"
                        x-transition>
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between py-1 border-bottom">
                                        <span>Tanggal Kembali Estimasi</span>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-muted mb-3">Buat rencana pelayaran baru untuk memulai operasional.
                                </p>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <p class="card-description mb-3">Semua pelayaran yang sudah ditutup dan data final sudah tersimpan.</p>
                                ...
                                <div class="card border h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="py-2 border-top border-bottom">
                                            <p class="mb-1"><small
                                                    class="text-muted">Seberangkat:</small><br>{{ $item->tanggal_berangkat?->format('d M Y') }}
                                            </p>
                                            <p class="mb-0"><small
                                                    class="text-muted">Kembali:</small><br>{{ $item->tanggal_selesai?->format('d M Y') ?? '-' }}
                                            </p>
                                        </div>
                                        <p class="small text-muted mt-2 mb-0">{{ $item->keterangan ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        @empty
                            ...
                            <tbody>
                                @forelse ($pelayaran as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->status_pelayaran === 'aktif')
                                                <span class="badge badge-success">Aktif</span>
                                            @elseif ($item->status_pelayaran === 'selesai')
                                                <span class="badge badge-secondary">Selesai</span>
                                            @else
                                                <span
                                                    class="badge badge-warning">{{ ucfirst($item->status_pelayaran) }}</span>
                                            @endif
                                        </td>
