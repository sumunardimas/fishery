        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <p class="card-description mb-0">Lengkapi sisa perbekalan dan hasil tangkapan untuk menutup pelayaran.
                    </p>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Data awal diambil dari perencanaan `perbekalan_pelayaran`.
                                    </p>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">Master ikan belum
                                                    tersedia.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
