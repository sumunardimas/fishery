        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="mb-1"><strong>Total Debit:</strong> Rp
                        {{ number_format($summary['total_masuk'], 2, ',', '.') }}</p>
                    <p class="mb-1"><strong>Total Kredit:</strong> Rp
                        {{ number_format($summary['total_keluar'], 2, ',', '.') }}</p>
                    <p class="mb-0"><strong>Mutasi Bersih:</strong> Rp {{ number_format($summary['net'], 2, ',', '.') }}
                    </p>
                </div>
            </div>
        </div>
