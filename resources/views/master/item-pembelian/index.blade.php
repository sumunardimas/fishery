...
@section('title', 'Master Item Barang Kantor')
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h4 class="card-title mb-1">Master Item Barang Kantor</h4>
                    <p class="card-description mb-4">Kelola data item untuk transaksi barang.</p>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Daftar Item Barang Kantor</h5>
                                ...
                                @forelse ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <form
                                                action="{{ route('master.item-pembelian.destroy', $item->id_item_pembelian) }}"
                                    ...
                                    <div class="modal fade" id="editItemPembelian{{ $item->id_item_pembelian }}"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    action="{{ route('master.item-pembelian.update', $item->id_item_pembelian) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
