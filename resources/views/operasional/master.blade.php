...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h4 class="card-title mb-1">Master Operasional Trip</h4>
                                    ...
                                    <div class="modal fade" id="editOperasional{{ $item->id_master_operasional }}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('master.operasional.update', $item) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_operasional"
                                                                class="form-control" value="{{ $item->nama_operasional }}"
                                                                required>
                                                        </div>
