                    ...
                    <form class="pt-3" method="post" action="/forgot-password">
                        ...
                        <div class="form-group">
                            <input name="email" type="email"
                                class="{{ $errors->has('email') ? 'is-invalid' : '' }} {{ session('status') ? 'is-valid' : '' }} form-control form-control-lg"
                        ...
                        <div class="mt-3">
                            <button type="submit"
                                class="btn btn-block btn-warning btn-lg font-weight-medium auth-form-btn">Kirim Link Reset
                                Password</button>
                        </div>
