                            ...
                            <form class="forms-sample" x-data="form_register" @submit.prevent="submit">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="{{ $formName }}"
                                        placeholder="{{ $formLabel }}" x-model.lazy="{{ $formName }}"
                                ...
                                <div class="alert alert-warning" role="alert">
                                    Akun yang dibuat melalui formulir ini hanya mendapat akses staff dasar dan tetap perlu
                                    ditinjau administrator.
                                </div>
