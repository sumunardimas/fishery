                ...
                <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                    ...
                    <form class="pt-3" @submit.prevent="submit">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-lg" id="Email1" placeholder="Email"
                                x-model.lazy="formData.email">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control form-control-lg" id="Password1"
                                placeholder="Password" x-model.lazy="formData.password">
                        </div>
                        <div class="mt-3">
                        ...
                        @else
                            <div class="text-center mt-4 font-weight-light">
                                Pembuatan akun baru ditangani oleh administrator sistem.
                            </div>
                        @endif
                    </form>
                </div>
